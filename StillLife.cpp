...
void URender2D()
{
    ...
    // Load texture files
    const char* texFileName = "C:/repos/Wk6Milestone/mortar (2).jpg";
    const char* texFileName2 = "C:/repos/Wk6Milestone/wood.jpg";
    const char* texFileName3 = "C:/repos/Wk6Milestone/glass.jpg";
    const char* texFileName4 = "C:/repos/Wk6Milestone/porcelain.jpg";
